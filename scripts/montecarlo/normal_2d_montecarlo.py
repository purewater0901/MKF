...
for value in values:
    x = value[0]
    theta = value[1]
    estimated_sum += x*x*math.cos(theta)*math.cos(theta)
estimated_mean = estimated_sum / num
print("E[X*X*cos(Y)*cos(Y)]: ", estimated_mean)
...
for value in values:
    x = value[0]
    theta = value[1]
    estimated_sum += x**2*math.sin(theta)**2
estimated_mean = estimated_sum / num
print("E[X*X*sin(Y)*sin(Y)]: ", estimated_mean)
...
for value in values:
    x = value[0]
    theta = value[1]
    estimated_sum += x*x*math.cos(theta)*math.sin(theta)
estimated_mean = estimated_sum / num
print("E[X*X*cos(Y)*sin(Y)]: ", estimated_mean)
...
for value in values:
    x = value[0]
    theta = value[1]
    estimated_sum += x*math.sin(theta)**2
estimated_mean = estimated_sum / num
print("E[X*sin(Y)*sin(Y)]: ", estimated_mean)
...
for value in values:
    x = value[0]
    theta = value[1]
    estimated_sum += x*math.cos(theta)**2
estimated_mean = estimated_sum / num
print("E[X*cos(Y)*cos(Y)]: ", estimated_mean)
"""
...
estimated_mean = estimated_sum / num
print("E[X*cos(Y)*sin(Y)]: ", estimated_mean)
