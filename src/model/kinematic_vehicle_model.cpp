...
Eigen::Vector4d KinematicVehicleModel::propagate(const Eigen::Vector4d& x_curr,
...
Eigen::Vector3d KinematicVehicleModel::observe(const Eigen::Vector4d& x_curr, const Eigen::Vector3d& observation_noise)
{
...
KinematicVehicleModel::StateMoments KinematicVehicleModel::propagateStateMoments(const StateMoments & prev_state_moments,
...
KinematicVehicleModel::ObservationMoments KinematicVehicleModel::getObservationMoments(const ReducedStateMoments & state_moments,
                                                                                       const ObservationNoiseMoments & observation_noise_moments)
{
    ...
    const double & vPow1_cPow1 = state_moments.vPow1_cPow1;

    const double & vPow1_yawPow1_cPow1 = state_moments.vPow1_yawPow1_cPow1;
    ...
    const double & vPow2_cPow2 = state_moments.vPow2_cPow2;
    const double & xPow2_vPow1_cPow1 = state_moments.xPow2_vPow1_cPow1;
    const double & yPow2_vPow1_cPow1 = state_moments.yPow2_vPow1_cPow1;

    // Observation Noise
    const double &wrPow1 = observation_noise_moments.wrPow1;
    const double &wvPow1 = observation_noise_moments.wvPow1;
    const double &wyawPow1 = observation_noise_moments.wyawPow1;
    const double &wrPow2 = observation_noise_moments.wrPow2;
    const double &wvPow2 = observation_noise_moments.wvPow2;
    const double &wyawPow2 = observation_noise_moments.wyawPow2;

    // Calculate Observation Moments
    ObservationMoments observation_moments;
    observation_moments.rPow1 = xPow2 + yPow2 + wrPow1;
    observation_moments.rPow2 = xPow4 + yPow4 + wrPow2 + 2.0*xPow2_yPow2 + 2.0*xPow2*wrPow1 + 2.0*yPow2*wrPow1;
    observation_moments.vcPow1 = vPow1_cPow1 + wvPow1;
    observation_moments.vcPow2 = vPow2_cPow2 + 2.0 * vPow1_cPow1 * wvPow1 + wvPow2;
    observation_moments.yawPow1 = yawPow1 + wyawPow1;
    observation_moments.yawPow2 = yawPow2 + wyawPow2 + 2.0*yawPow1*wyawPow1;
    observation_moments.rPow1_vcPow1 = xPow2_vPow1_cPow1 + yPow2_vPow1_cPow1 + vPow1_cPow1 * wrPow1 + wvPow1 * xPow2 + wvPow1 * yPow2 + wrPow1*wvPow1;
    observation_moments.rPow1_yawPow1 = xPow2_yawPow1 + yPow2_yawPow1 + yawPow1*wrPow1 + xPow2*wyawPow1 + yPow2*wyawPow1 + wrPow1*wyawPow1;
    observation_moments.vcPow1_yawPow1 = vPow1_yawPow1_cPow1 + yawPow1 * wvPow1 + vPow1_cPow1 * wyawPow1 + wvPow1 * wyawPow1;
